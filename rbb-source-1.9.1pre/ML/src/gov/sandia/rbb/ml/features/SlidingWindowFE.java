...
/**
 *
 * SlidingWindowFE is a base class for other feature extractors.
 * It buffers observations for subsequent feature extraction.
 *
 * The amount of buffering is
 * 
 * feature (x) increased by a specified amount (dx).
 * x is normally time, or else distance.
 *
 ...
 * @author rgabbot
 */
public class SlidingWindowFE extends MLFeatureExtractor {
    ...
    *
    */
    public SlidingWindowFE(String dydtOutput, String yInput, Float dt, MLFeatureExtractor next) {
     ...
     *
     */
    public SlidingWindowFE(String dydxOutput, String yInput, String xInput, Float dx, MLFeatureExtractor next) {
